    ...
    try {
        ...
        const noDups = function () {
                ...
                if (charLen >= settingLen) {
                    ...
                    const err = new Error("Invalid length for non duplicate string (" + settingLen + " chars). Length option cannot be greater than the total number of characters in the pool (" + charLen + " chars).");
                    throw err;
            }
        };
