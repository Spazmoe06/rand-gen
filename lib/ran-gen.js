...
module.exports = exports = ranGen = function scope (params) {
    try {
        // Call reset to make sure each call to ran-gen is in a known state.
        _reset();
        _setParams(params);

        const numberOnly = function () {
        ...
        //             return retStr;
        //         } else {
        //             throw "The max length of the string (" + settingLen + " chars) must be greater than the total number of characters (" + charLen + " chars).";
        //         }
        //     } catch (e) {
        //         console.log(e);
        //     }
...
ranGen.version = "v" + packageJSON.version;
